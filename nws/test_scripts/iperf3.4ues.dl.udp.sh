#!/bin/bash
# 4 UEs DL UDP: tmux window "srv" = host iperf3 -s :5201..5204, window "ue" = UE clients iperf3 -u -R.
...
echo "Windows: srv (4× iperf3 -s), ue (4× UE UDP clients)  |  tmux session: $SESSION"
