#!/bin/bash
# 3 UEs UL UDP: tmux window "srv" = host iperf3 -s :5201..5203, window "ue" = UE clients iperf3 -u.
...
echo "Windows: srv (3× iperf3 -s), ue (3× UE UL UDP clients)  |  tmux session: $SESSION"
