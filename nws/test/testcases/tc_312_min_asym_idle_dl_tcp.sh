#!/bin/bash
# ========================================================================
# Test Case 312: min_asym_idle_dl_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. Unused min PRBs are surrendered to UE1. (Downlink TCP)
# ========================================================================
# Usage: ./tc_312_min_asym_idle_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
