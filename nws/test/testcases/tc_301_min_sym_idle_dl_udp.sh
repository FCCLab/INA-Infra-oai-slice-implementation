#!/bin/bash
# ========================================================================
# Test Case 301: min_sym_idle_dl_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Unused min PRBs from idle slices are surrendered to UE1. (Downlink UDP)
# ========================================================================
# Usage: ./tc_301_min_sym_idle_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
