#!/bin/bash
# ========================================================================
# Test Case 318: min_asym_full_ul_tcp
# Description: Slices 1-4 get 20% min (~27 PRBs); Slice 5 gets 10% min (~13 PRBs). (Uplink TCP)
# ========================================================================
# Usage: ./tc_318_min_asym_full_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
