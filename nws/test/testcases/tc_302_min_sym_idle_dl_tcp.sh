#!/bin/bash
# ========================================================================
# Test Case 302: min_sym_idle_dl_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. Unused min PRBs from idle slices are surrendered to UE1. (Downlink TCP)
# ========================================================================
# Usage: ./tc_302_min_sym_idle_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
