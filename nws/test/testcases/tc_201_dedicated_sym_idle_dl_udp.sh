#!/bin/bash
# ========================================================================
# Test Case 201: dedicated_sym_idle_dl_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (4x15%=60%) remain strictly RESERVED. (Downlink UDP)
# ========================================================================
# Usage: ./tc_201_dedicated_sym_idle_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
