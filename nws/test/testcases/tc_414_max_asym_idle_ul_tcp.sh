#!/bin/bash
# ========================================================================
# Test Case 414: max_asym_idle_ul_tcp
# Description: UE5 full traffic (50% max); UEs 1-4 IDLE. UE5 is strictly capped at 50% capacity despite idle channel. (Uplink TCP)
# ========================================================================
# Usage: ./tc_414_max_asym_idle_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
