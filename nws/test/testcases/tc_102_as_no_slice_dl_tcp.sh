#!/bin/bash
# ========================================================================
# Test Case 102: as_no_slice_dl_tcp
# Description: As-no-slice DL TCP (0/0/100% under NSBOTH). All 5 UEs active.
# ========================================================================
# Usage: ./tc_102_as_no_slice_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
