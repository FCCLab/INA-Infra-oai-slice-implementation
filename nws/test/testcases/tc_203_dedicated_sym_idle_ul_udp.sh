#!/bin/bash
# ========================================================================
# Test Case 203: dedicated_sym_idle_ul_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (4x15%=60%) remain strictly RESERVED. (Uplink UDP)
# ========================================================================
# Usage: ./tc_203_dedicated_sym_idle_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
