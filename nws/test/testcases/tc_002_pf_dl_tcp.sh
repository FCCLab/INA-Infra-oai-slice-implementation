#!/bin/bash
# ========================================================================
# Test Case 002: pf_dl_tcp
# Description: Pure OAI Proportional Fair scheduler (sch=PF). Downlink TCP full traffic across all 5 UEs.
# ========================================================================
# Usage: ./tc_002_pf_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
