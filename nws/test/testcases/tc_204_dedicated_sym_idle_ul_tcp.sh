#!/bin/bash
# ========================================================================
# Test Case 204: dedicated_sym_idle_ul_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (4x15%=60%) remain strictly RESERVED. (Uplink TCP)
# ========================================================================
# Usage: ./tc_204_dedicated_sym_idle_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
