#!/bin/bash
# ========================================================================
# Test Case 313: min_asym_idle_ul_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Unused min PRBs are surrendered to UE1. (Uplink UDP)
# ========================================================================
# Usage: ./tc_313_min_asym_idle_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
