#!/bin/bash
# ========================================================================
# Test Case 303: min_sym_idle_ul_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Unused min PRBs from idle slices are surrendered to UE1. (Uplink UDP)
# ========================================================================
# Usage: ./tc_303_min_sym_idle_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
