#!/bin/bash
# ========================================================================
# Test Case 215: dedicated_asym_full_dl_udp
# Description: Slices 1-4 get 15% dedicated (~20 PRBs); Slice 5 gets 7% dedicated (~9 PRBs). (Downlink UDP)
# ========================================================================
# Usage: ./tc_215_dedicated_asym_full_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
