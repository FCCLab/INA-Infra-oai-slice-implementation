#!/bin/bash
# ========================================================================
# Test Case 418: max_asym_full_ul_tcp
# Description: Slices 1-3 uncapped (100%); Slices 4-5 strictly capped at 50% ceiling. (Uplink TCP)
# ========================================================================
# Usage: ./tc_418_max_asym_full_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
