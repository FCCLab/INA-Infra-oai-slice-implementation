#!/bin/bash
# ========================================================================
# Test Case 001: pf_dl_udp
# Description: Pure OAI Proportional Fair scheduler (sch=PF). Downlink UDP full traffic across all 5 UEs.
# ========================================================================
# Usage: ./tc_001_pf_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
