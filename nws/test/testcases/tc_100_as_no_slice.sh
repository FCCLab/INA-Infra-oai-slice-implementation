#!/bin/bash
# ========================================================================
# Test Case 100: as_no_slice
# Description: As-no-slice baseline (0/0/100% under NSBOTH). 30s ping test across all 5 UEs.
# ========================================================================
# Usage: ./tc_100_as_no_slice.sh [--time <seconds>] [--skip-prep]
# ========================================================================
