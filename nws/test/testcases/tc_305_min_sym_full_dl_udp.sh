#!/bin/bash
# ========================================================================
# Test Case 305: min_sym_full_dl_udp
# Description: Equal 20% minimum per slice (~27 PRBs each) with dedicated=0, max=100%. (Downlink UDP)
# ========================================================================
# Usage: ./tc_305_min_sym_full_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
