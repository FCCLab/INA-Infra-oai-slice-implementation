#!/bin/bash
# ========================================================================
# Test Case 306: min_sym_full_dl_tcp
# Description: Equal 20% minimum per slice (~27 PRBs each) with dedicated=0, max=100%. (Downlink TCP)
# ========================================================================
# Usage: ./tc_306_min_sym_full_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
