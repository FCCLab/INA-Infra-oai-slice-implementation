#!/bin/bash
# ========================================================================
# Test Case 207: dedicated_sym_full_ul_udp
# Description: Equal 15% dedicated per slice (~20 PRBs each on 133 PRB carrier). (Uplink UDP)
# ========================================================================
# Usage: ./tc_207_dedicated_sym_full_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
