#!/bin/bash
# ========================================================================
# Test Case 408: max_sym_full_ul_tcp
# Description: No ceiling cap. All 5 slices compete freely for full 133 PRBs. (Uplink TCP)
# ========================================================================
# Usage: ./tc_408_max_sym_full_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
