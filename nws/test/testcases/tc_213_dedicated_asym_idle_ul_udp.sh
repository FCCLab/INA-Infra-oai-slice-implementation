#!/bin/bash
# ========================================================================
# Test Case 213: dedicated_asym_idle_ul_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (52%) remain strictly RESERVED. (Uplink UDP)
# ========================================================================
# Usage: ./tc_213_dedicated_asym_idle_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
