#!/bin/bash
# ========================================================================
# Test Case 304: min_sym_idle_ul_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. Unused min PRBs from idle slices are surrendered to UE1. (Uplink TCP)
# ========================================================================
# Usage: ./tc_304_min_sym_idle_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
