#!/bin/bash
# ========================================================================
# Test Case 401: max_sym_idle_dl_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. UE1 bursts freely across entire cell bandwidth. (Downlink UDP)
# ========================================================================
# Usage: ./tc_401_max_sym_idle_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
