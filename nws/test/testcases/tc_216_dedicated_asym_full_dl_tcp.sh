#!/bin/bash
# ========================================================================
# Test Case 216: dedicated_asym_full_dl_tcp
# Description: Slices 1-4 get 15% dedicated (~20 PRBs); Slice 5 gets 7% dedicated (~9 PRBs). (Downlink TCP)
# ========================================================================
# Usage: ./tc_216_dedicated_asym_full_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
