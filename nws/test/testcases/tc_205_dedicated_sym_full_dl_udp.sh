#!/bin/bash
# ========================================================================
# Test Case 205: dedicated_sym_full_dl_udp
# Description: Equal 15% dedicated per slice (~20 PRBs each on 133 PRB carrier). (Downlink UDP)
# ========================================================================
# Usage: ./tc_205_dedicated_sym_full_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
