#!/bin/bash
# ========================================================================
# Test Case 403: max_sym_idle_ul_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. UE1 bursts freely across entire cell bandwidth. (Uplink UDP)
# ========================================================================
# Usage: ./tc_403_max_sym_idle_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
