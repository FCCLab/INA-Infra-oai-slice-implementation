#!/bin/bash
# ========================================================================
# Test Case 211: dedicated_asym_idle_dl_udp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (52%) remain strictly RESERVED. (Downlink UDP)
# ========================================================================
# Usage: ./tc_211_dedicated_asym_idle_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
