#!/bin/bash
# ========================================================================
# Test Case 202: dedicated_sym_idle_dl_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (4x15%=60%) remain strictly RESERVED. (Downlink TCP)
# ========================================================================
# Usage: ./tc_202_dedicated_sym_idle_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
