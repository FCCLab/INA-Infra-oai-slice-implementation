#!/bin/bash
# ========================================================================
# Test Case 413: max_asym_idle_ul_udp
# Description: UE5 full traffic (50% max); UEs 1-4 IDLE. UE5 is strictly capped at 50% capacity despite idle channel. (Uplink UDP)
# ========================================================================
# Usage: ./tc_413_max_asym_idle_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
