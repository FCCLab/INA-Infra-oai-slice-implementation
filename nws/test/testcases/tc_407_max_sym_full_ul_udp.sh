#!/bin/bash
# ========================================================================
# Test Case 407: max_sym_full_ul_udp
# Description: No ceiling cap. All 5 slices compete freely for full 133 PRBs. (Uplink UDP)
# ========================================================================
# Usage: ./tc_407_max_sym_full_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
