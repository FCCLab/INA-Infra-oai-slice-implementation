#!/bin/bash
# ========================================================================
# Test Case 316: min_asym_full_dl_tcp
# Description: Slices 1-4 get 20% min (~27 PRBs); Slice 5 gets 10% min (~13 PRBs). (Downlink TCP)
# ========================================================================
# Usage: ./tc_316_min_asym_full_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
