#!/bin/bash
# ========================================================================
# Test Case 404: max_sym_idle_ul_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. UE1 bursts freely across entire cell bandwidth. (Uplink TCP)
# ========================================================================
# Usage: ./tc_404_max_sym_idle_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
