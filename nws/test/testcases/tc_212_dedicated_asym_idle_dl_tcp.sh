#!/bin/bash
# ========================================================================
# Test Case 212: dedicated_asym_idle_dl_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. Slices 2-5 dedicated PRBs (52%) remain strictly RESERVED. (Downlink TCP)
# ========================================================================
# Usage: ./tc_212_dedicated_asym_idle_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
