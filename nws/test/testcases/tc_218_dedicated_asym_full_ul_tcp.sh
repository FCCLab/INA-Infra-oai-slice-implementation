#!/bin/bash
# ========================================================================
# Test Case 218: dedicated_asym_full_ul_tcp
# Description: Slices 1-4 get 15% dedicated (~20 PRBs); Slice 5 gets 7% dedicated (~9 PRBs). (Uplink TCP)
# ========================================================================
# Usage: ./tc_218_dedicated_asym_full_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
