#!/bin/bash
# ========================================================================
# Test Case 308: min_sym_full_ul_tcp
# Description: Equal 20% minimum per slice (~27 PRBs each) with dedicated=0, max=100%. (Uplink TCP)
# ========================================================================
# Usage: ./tc_308_min_sym_full_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
