#!/bin/bash
# ========================================================================
# Test Case 217: dedicated_asym_full_ul_udp
# Description: Slices 1-4 get 15% dedicated (~20 PRBs); Slice 5 gets 7% dedicated (~9 PRBs). (Uplink UDP)
# ========================================================================
# Usage: ./tc_217_dedicated_asym_full_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
