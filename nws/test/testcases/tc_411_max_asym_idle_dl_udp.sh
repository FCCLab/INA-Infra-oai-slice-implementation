#!/bin/bash
# ========================================================================
# Test Case 411: max_asym_idle_dl_udp
# Description: UE5 full traffic (50% max); UEs 1-4 IDLE. UE5 is strictly capped at 50% capacity despite idle channel. (Downlink UDP)
# ========================================================================
# Usage: ./tc_411_max_asym_idle_dl_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
