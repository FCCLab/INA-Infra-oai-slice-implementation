#!/bin/bash
# ========================================================================
# Test Case 307: min_sym_full_ul_udp
# Description: Equal 20% minimum per slice (~27 PRBs each) with dedicated=0, max=100%. (Uplink UDP)
# ========================================================================
# Usage: ./tc_307_min_sym_full_ul_udp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
