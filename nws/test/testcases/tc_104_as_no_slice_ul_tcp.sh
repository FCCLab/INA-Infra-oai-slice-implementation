#!/bin/bash
# ========================================================================
# Test Case 104: as_no_slice_ul_tcp
# Description: As-no-slice UL TCP (0/0/100% under NSBOTH). All 5 UEs active.
# ========================================================================
# Usage: ./tc_104_as_no_slice_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
