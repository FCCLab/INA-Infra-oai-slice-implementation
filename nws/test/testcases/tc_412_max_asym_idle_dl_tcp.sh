#!/bin/bash
# ========================================================================
# Test Case 412: max_asym_idle_dl_tcp
# Description: UE5 full traffic (50% max); UEs 1-4 IDLE. UE5 is strictly capped at 50% capacity despite idle channel. (Downlink TCP)
# ========================================================================
# Usage: ./tc_412_max_asym_idle_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
