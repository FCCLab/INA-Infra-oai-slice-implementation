#!/bin/bash
# ========================================================================
# Test Case 406: max_sym_full_dl_tcp
# Description: No ceiling cap. All 5 slices compete freely for full 133 PRBs. (Downlink TCP)
# ========================================================================
# Usage: ./tc_406_max_sym_full_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
