#!/bin/bash
# ========================================================================
# Test Case 206: dedicated_sym_full_dl_tcp
# Description: Equal 15% dedicated per slice (~20 PRBs each on 133 PRB carrier). (Downlink TCP)
# ========================================================================
# Usage: ./tc_206_dedicated_sym_full_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
