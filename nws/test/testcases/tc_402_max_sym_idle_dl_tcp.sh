#!/bin/bash
# ========================================================================
# Test Case 402: max_sym_idle_dl_tcp
# Description: UE1 full traffic; UEs 2-5 IDLE. UE1 bursts freely across entire cell bandwidth. (Downlink TCP)
# ========================================================================
# Usage: ./tc_402_max_sym_idle_dl_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
