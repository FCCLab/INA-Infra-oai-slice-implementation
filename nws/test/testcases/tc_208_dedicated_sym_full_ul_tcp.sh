#!/bin/bash
# ========================================================================
# Test Case 208: dedicated_sym_full_ul_tcp
# Description: Equal 15% dedicated per slice (~20 PRBs each on 133 PRB carrier). (Uplink TCP)
# ========================================================================
# Usage: ./tc_208_dedicated_sym_full_ul_tcp.sh [--time <seconds>] [--skip-prep]
# ========================================================================
