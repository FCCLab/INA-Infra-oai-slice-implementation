// rapp.config.jsx — NeuroRAN Network Slicing rApp Manifest
...
const RAPP_CONFIG = {
  brand: {
    product: "NeuroRAN",
    shortName: "NWS-rApp",
    title: "NeuroRAN Network Slicing rApp",
    logo: "logo/NeuroRAN.png",
    logoPng: "logo/NeuroRAN.png",
  },

  site: {
    label: "Non-RT RIC (SMO)",
    id: "nonrtric-smo",
  ...
  tabs: [
    { id: "sla",      label: "A1 Slice SLA",    icon: ICONS.gear,  component: "SlaTab" },
    { id: "policies", label: "Active Policies", icon: ICONS.table, component: "PoliciesTab" },
