#!/usr/bin/env bash
# N6-bound iperf3 servers for 3 UEs (10.47.0.101–103). One server per pane on nws-n6.

set -euo pipefail

SESSION_NAME="nws-iperf3-servers-3ue"
N6_DEV="nws-n6"
PREFIX_LEN="24"
TMUX_WIDTH="240"
TMUX_HEIGHT="72"
...
echo
echo "tmux session '${SESSION_NAME}' is ready (3× iperf3 on N6)."
