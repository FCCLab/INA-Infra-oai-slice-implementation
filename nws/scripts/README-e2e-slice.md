...
2. **RAN**: `nws/docker-compose.open5gs.5slices.yaml` expects **external** network `nws-n2n3` (start 5GC first). Build OAI images from `nws/` if needed: `docker compose -f docker-compose.open5gs.5slices.yaml build`.
