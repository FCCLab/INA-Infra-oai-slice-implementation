#!/bin/bash
# 3 UEs DL TCP: tmux window "srv" = host iperf3 -s :5201..5203, window "ue" = UE clients iperf3 -R.
...
echo "Windows: srv (3× iperf3 -s), ue (3× UE TCP clients)  |  tmux session: $SESSION"
